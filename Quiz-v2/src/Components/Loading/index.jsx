...
export default function Loading() {
  ...
  {/* Radial gradient background to give it depth */}
  ...
  <div className="relative flex flex-col items-center">
    {/* Your Grid Component with a new color */}
    <Grid width={80} height={80} color="#a78bfa" /> 
    
    {/* Subtle text under the grid */}
    <span className="mt-8 text-zinc-400 font-medium tracking-tight">
      Syncing with <span className="text-violet-400">Storefront...</span>
    </span>
  </div>
</div>
  );
